...
<body>
            <table class="table">
                    ...
                    <tr>
                        ...
                        <td>${{ number_format($credito->pagado) }}</td>
                        <td>${{ number_format($credito->interes_mora) }}</td>
                        <td>${{ number_format($credito->gastos_cobranza) }}</td>
                        ...
                        <td>${{ number_format($credito->totalPagar) }}</td>
                        <td>${{ number_format($credito->saldoDia) }}</td>
                        <td>{{ $credito->diasMesesVencimiento}}</td>
                        <td>{{ $credito->diasMora}}</td>
