...
{
    private $NAME_CONTROLLER = 'AtributosController';
        /**
     * @var $repository
     */
    ...
    function getAll(Request $request){
        try{
            ...
            $result = $this->repository->orderBy('variable','asc')->paginate($per_page);
            $response = $result;
    ...
    function create(Request $request){
      ...
      function update(Request $request){
        try{
           ...
           $user = Atributos::find($request->id);
